...
//   // ✅ 1) 장바구니에서 온 snapshot이 있다면, 그걸로 먼저 세팅
//   useEffect(() => {
...
//         items,
//         totalPrice,
//         provisional: true, // 장바구니 경유 데이터라는 표시
//       });
//       setIsLoadingOrder(false);
//     }
//   }, [snapshot, orderId]);

//   // ✅ 2) snapshot이 없고, orderId만 있는 경우에만 서버에서 주문 상세 조회
//   useEffect(() => {
//     // ❗ snapshot이 있으면, 이미 위에서 orderData를 채웠으니까 여기선 아무 것도 안 함
//     if (snapshot?.items?.length) {
//       return;
//     }
...
//   [rawTotal]
// );
//   const shippingFeeDisplay = shippingFee === 0 ? "30,000원 이상 결제시 배송비 무료" : `${shippingFee.toLocaleString()}원`;
    ...
    <S.OrderPageWrap className={isCandy ? "candy-mode" : ""}>
      <S.OrderMainSection>
        ...
        <PaymentMethod
          value={payType}
          onChange={setPayType}
          // 필요하면 일반 결제 방식 선택을 위해 props 추가 가능
          // generalMethod={generalMethod}
          // onChangeGeneralMethod={setGeneralMethod}
        />
      </S.OrderMainSection>
